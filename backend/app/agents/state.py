...
class AgentState(TypedDict):
    ...
    route: str                          # Routing decision: llm_only | retrieval | web_search | both | data_analysis
    ...
    sources: str                        # Which tools were used: llm_only | retrieval | web_search | both | data_analysis
    ...
    data_analysis_result: dict | None   # Structured result from data_agent_node, or None
